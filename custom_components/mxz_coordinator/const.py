...
# Optional per-zone "airflow" sensor: the actual blower speed some firmwares
...
# ON by default since v2.10.0/v3.0.0 (opt-out via the Configure dialog) — it's simply a
